// src/components/AlertasBell.jsx (v2 - duas categorias)
// ----------------------------------------------------------------------------
// Sino de alertas com 2 abas:
//   - "Voce ja vende" 🔥 (categoria=ja_vendo) - sniper, urgencia
//   - "Descobrir"     💎 (categoria=descoberta) - produtos novos pra explorar
// ----------------------------------------------------------------------------
...
export default function AlertasBell() {
  ...
  // Separa por categoria. Itens sem categoria (legados do v1) caem em ja_vendo.
