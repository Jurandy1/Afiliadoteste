// src/pages/GarimpoPage.jsx
// ----------------------------------------------------------------------------
// Pagina do Robo de Garimpo.
// Mostra todos os produtos do snapshot mais recente em tabela ordenavel,
// com 2 abas (Voce ja vende / Descobrir), busca por nome, filtros de
// comissao minima e score minimo.
// ----------------------------------------------------------------------------
import { useState, useEffect, useMemo } from "react";
import { Sparkles, Copy, ExternalLink, Search, TrendingUp, Gem } from "lucide-react";
import {
...
export default function GarimpoPage() {
  ...
  // UI state
  const [abaAtiva, setAbaAtiva] = useState("ja_vendo"); // ja_vendo | descoberta
