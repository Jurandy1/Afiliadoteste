...
export default function Sidebar({ activeRoute, alertCount, onNavigate }) {
  return (
    <aside className="w-[230px] bg-sidebar text-slate-400 flex flex-col sticky top-0 h-screen">
      <div className="px-5 py-5 border-b border-slate-800 flex items-center gap-3">
        ...
        <div>
          <div className="text-white font-semibold text-sm leading-tight">AffiliateHub</div>
