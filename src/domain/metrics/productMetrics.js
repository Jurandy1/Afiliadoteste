export function calcMetrics(produto) {
  ...
  const origem =
    (produto.fonte === "shopee_venda" || produto.fonte === "shopee_venda_append") ? "Shopee" :
    (produto.fonte === "shopee_clique" || produto.fonte === "shopee_clique_append" || produto.fonte === "shopee_cliques") ? "Cliques" :
    "Manual";
